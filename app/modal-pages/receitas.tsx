    ...
    <SafeAreaView className="flex-1 bg-white">
      <View className="flex-1">
        ...
        <View className="flex-row justify-between items-center p-4 border-b border-gray-200">
          ...
          <Text className="text-lg font-semibold">Nova Receita</Text>
        ...
        <ScrollView className="flex-1 p-4">
          <View className="space-y-6">
            {/* Nome */}
            <View>
              <Text className="text-sm font-medium text-gray-700 mb-2">Nome da Receita</Text>
              <TextInput
        ...
        >
          <View className="flex-1 bg-black/50 justify-end">
            <View className="bg-white rounded-t-3xl">
                  ...
                  >
                    {index === 0 ? (
                      <View className="flex-row items-center">
                        ...
                        <Text className="text-green-500 font-medium">{cat}</Text>
                      </View>
                    ) : (
              ...
              >
                <Text className="text-center text-green-500 font-medium">Cancelar</Text>
              </TouchableOpacity>
            </View>
          </View>
        </Modal>
              ...
              <View className="p-4">
                ...
                <View className="flex-row space-x-4">
                  ...
                  <TouchableOpacity
                    ...
                    className="flex-1 p-4 bg-green-500 rounded-xl"
                  >
